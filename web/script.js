...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateCellSize(columns, rows, containerSelector) {
        ...
        const maxCellWidth = Math.floor((availableWidth - (columns - 1) * cellGap) / columns);
    ...
    function initPixelGrid(customSize = null) {
        ...
        const columns = parseInt(localStorage.getItem('gridColumns')) || parseInt(columnsInput.value) || 5;
        const rows = parseInt(localStorage.getItem('gridRows')) || parseInt(rowsInput.value) || 5;
        ...
        setTimeout(() => {
            ...
            document.documentElement.style.setProperty('--pixel-cell-size', `${cellSize}px`);
            ...
            if (pixelContainer) {
                pixelContainer.scrollLeft = (pixelContainer.scrollWidth - pixelContainer.clientWidth) / 2;
                pixelContainer.scrollTop = (pixelContainer.scrollHeight - pixelContainer.clientHeight) / 2;
            }
        }, 100);
    }
    ...
    document.querySelector('[data-target="pixel-control"]').addEventListener('click', function() {
    ...
    connectBtn.addEventListener('click', function() {
        ...
        if (selectedDevice) {
            currentDevice.textContent = deviceList.options[deviceList.selectedIndex].text;
    ...
    document.getElementById('load-grid-btn').addEventListener('click', function() {
