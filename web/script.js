...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function handleResize() {
    ...
    const gridEditorActive = document.getElementById("grid-editor").classList.contains("active")
    const pixelControlActive = document.getElementById("pixel-control").classList.contains("active")
